    ...
    <>
      ...
      {!loading &&
        <div className="relative flex flex-row w-full">
          ...
          <div className="flex-1 flex flex-row bg-[#4300ff] bg-[linear-gradient(5deg,_#3f3cbb_0%,_#717371_100%)]">
            <Sidebar />
          ...
          {activeSong?.name && (
            isMobileScreen ?
              <div className="fixed bottom-0 left-0 right-0 h-32 z-10 animate-slideup bg-[#4300ff] bg-[linear-gradient(5deg,_#3f3cbb_0%,_#717371_100%)] rounded-t-3xl ">
                <MusicPlayer />
              </div> : <div className="absolute h-28  bottom-0 left-0 right-0 flex animate-slideup bg-[#4300ff] bg-[linear-gradient(5deg,_#3f3cbb_0%,_#717371_100%)] rounded-t-3xl z-10">
                <MusicPlayer />
              </div>
          )}
        </div>
