...
import github from 'react-useanimations/lib/activity'
  ...
  <div className="mt-10 mr-5">
    {links.map((item) => (
      <Link
        key={item.name}
        href={item.href}
        className="flex flex-row justify-start items-center my-8 py-2 text-sm font-medium text-light-1 hover:text-tahiti hover:bg-light-1 rounded-xl"
    ...
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-dark-1 ">
        <div className="flex justify-between">
          <UseAnimations animation={github} size={56} strokeColor='#ae00ff' fillColor='#ae00ff' autoplay loop />
          <UseAnimations animation={skipBack} size={56} strokeColor='#ae00ff' fillColor='#ae00ff' autoplay loop />
          <UseAnimations animation={infinity} size={56} strokeColor='#ae00ff' fillColor='#ae00ff' autoplay loop />
